...
export interface CropModalProps {
  crop: {
    ...
    idealHumadity?: number;
    idealRainfall?: number;
    idealFertilizers?: string;
  };
  onClose: () => void;
}
        ...
        <div className="flex justify-between items-center border-b p-4">
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <div className="flex items-center gap-4 mt-2 text-sm text-gray-600">
              {crop.idealTemperature !== undefined && (
                <div className="flex items-center gap-1">
                  <Thermometer className="w-4 h-4 text-red-500" />
                  <span>{crop.idealTemperature} °C</span>
                </div>
              )}
              {crop.idealHumadity !== undefined && (
                <div className="flex items-center gap-1">
                  <Droplets className="w-4 h-4 text-blue-500" />
                  <span>{crop.idealHumadity} %</span>
                </div>
              )}
              {crop.idealRainfall !== undefined && (
                <div className="flex items-center gap-1">
                  <CloudRain className="w-4 h-4 text-indigo-500" />
                  <span>{crop.idealRainfall} mm</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-2/3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {crop.idealFertilizers && (
                  <div className="bg-blue-50 p-3 rounded-lg">
                    <h4 className="font-medium text-blue-800 mb-1">
                      Ideal Fertilizers
                    </h4>
                    <p>{crop.idealFertilizers}</p>
                  </div>
                )}
              </div>
            </div>
