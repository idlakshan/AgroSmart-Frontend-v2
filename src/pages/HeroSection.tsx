  ...
  return (
    <div className="relative h-125 md:h-150 overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://plus.unsplash.com/premium_photo-1664300227447-d97609bbcb43?q=80&w=1214&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
      ...
      <div className="relative h-full flex flex-col justify-center items-start text-left px-6 md:px-12 lg:px-24 z-10">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 max-w-2xl">
          Precision Agriculture with <span className="text-green-300"></span>{" "}
          Soil Analysis
        </h1>
